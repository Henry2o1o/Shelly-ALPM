...
pub const UpdatePage = extern struct {
    ...
    pub fn onMap(self: *Self) void {
        ...
        gtk.Label.setLabel(p.status_label, "update — loaded");
    ...
    pub fn onUnmap(self: *Self) void {
        ...
        gtk.Label.setLabel(p.status_label, "update — unloaded");
    }
    ...
    pub const Class = extern struct {
        ...
        fn init(class: *Class) callconv(.c) void {
            ...
            support.bindChild(class, Private.offset, "status_label", @offsetOf(Private, "status_label"));
            support.bindChild(class, Private.offset, "content_list", @offsetOf(Private, "content_list"));
        }
    };
};
